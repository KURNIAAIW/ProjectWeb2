...
$countQuery = "SELECT COUNT(*) FROM transactions WHERE type = 'online'";
...
FROM (
    SELECT 
        ...
        t.created_at
    FROM transactions t
    JOIN products p ON t.product_id = p.id WHERE t.type = 'online'
) AS monthly_revenue
  ...
  <div id="app">
    ...
    <div id="main">
      ...
      <section class="section">
        ...
        <div class="card">
          <div class="card-header">
            <h5 class="card-title">Daftar Transaksi Online</h5>
          </div>
            ...
            <table class="table">
              <thead>
                <tr>
                  ...
                  <th scope="col">
                    <div style="width: max-content;">Nama Pelanggan</div>
                  </th>
                  <th scope="col">
                    <div style="width: max-content;">Nomor HP Pelanggan</div>
                  </th>
              ...
              <tbody>
                ...
                <?php foreach ($result as $product) : ?>
                  <tr>
                    ...
                    <td>
                      <div style="width: 300px;"><?= $product['address'] ?></div>
                    </td>
                    ...
                    <td>
                      <?php if ($product['is_confirmed'] == 0): ?>
                        <a href="approve.php?id=<?= $product['transaction_id'] ?>" class="btn btn-primary">
                          <svg fill="#00ff00" height="188px" width="188px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 50 50" enable-background="new 0 0 50 50" xml:space="preserve" stroke="#00ff00" stroke-width="3.05">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                              <path d="M40.267,14.628L20.974,33.921l-9.293-9.293c-0.391-0.391-1.023-0.391-1.414,0s-0.391,1.023,0,1.414l10,10 c0.195,0.195,0.451,0.293,0.707,0.293s0.512-0.098,0.707-0.293l20-20c0.391-0.391,0.391-1.023,0-1.414S40.657,14.237,40.267,14.628z "></path>
                            </g>
                          </svg>
                        </a>
                        <a href="decline.php?id=<?= $product['transaction_id'] ?>" class="btn btn-primary">
                          <svg height="200px" width="200px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 50 50" enable-background="new 0 0 50 50" xml:space="preserve" fill="#ff0000" stroke="#ff0000" stroke-width="3.1">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
